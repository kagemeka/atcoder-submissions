    ...
    def bfs01(self, src):
      ...
      while q:
        ...
        for v, e in self.edges[u].items():
          ...
          # d[v] = d[u] + e.weight
          # d[v] = dv
          if e.weight: q.append((dv, v))
          else: q.appendleft((dv, v))
      # return d
  ...
  class ABC077:
    ...
    def d():
      ...
      for i in range(k):
        ...
        g.add_edge(i, (i+1)%k, weight=1)

      # # print(g.edges)
      # # for i in range(k):
      # #   for v, e in g.edges[i].items():
      # #     print(i, v, e)

      # # print(1+g.dijkstra(1)[0])
      # # print(1+g.bfs01(1)[0])
      print(g.bfs01(1))
      ...
      #   if visited[u]: continue
      #   visited[u] = True
      #   if u==0: print(d); return
      #   q.appendleft((d, u*10%k))
      #   q.append((d+1, (u+1)%k))
