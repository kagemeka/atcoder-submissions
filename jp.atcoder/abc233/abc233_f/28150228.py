...
def main() -> typing.NoReturn:
    ...
    for u in range(n):
        if added[u]: continue
        dist, prev, parent = bfs_sparse(g, u)
        ...
        for v, d in cand: 
            ...
            right_edges = []
            right_order = []
            while dist[src] > dist[tgt]:
                left_order.append(src)
                src, e = prev[src]
                left_edges.append(e)
                
            while dist[tgt] > dist[src]:
                right_order.append(tgt)
                tgt, e = prev[tgt]
            ...
            edges = left_edges + right_edges[::-1]
